JSON Schemas for Jamf Pro - For configuration of application settings from within the Jamf web GUI, to help simplify configuration of application settings from within the Jamf Pro GUI.
